...
import (
	...
	"github.com/gdubicki/helm-diff/v3/diff"
	"github.com/gdubicki/helm-diff/v3/manifest"
)
...
func (d *diffCmd) isAllowUnreleased() bool {
	...
	// https://github.com/gdubicki/helm-diff/issues/108
...
func newChartCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: strings.Join([]string{
			...
			"  # See https://github.com/gdubicki/helm-diff/issues/278 for more information.",
			...
			"  # See https://github.com/gdubicki/helm-diff/issues/253 for more information.",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			// See https://github.com/gdubicki/helm-diff/issues/253
	...
	// - https://github.com/gdubicki/helm-diff/issues/318
...
func deleteStatusAndTidyMetadata(obj []byte) (map[string]interface{}, error) {
	...
	// https://github.com/gdubicki/helm-diff/issues/326#issuecomment-1008253274
